...
contract BikeShare{
    ...
    function ReturnBike()public returns(bool success){
      ...
      myogg.transferFrom(address(this),msg.sender,Payments[msg.sender]);
      id--;
